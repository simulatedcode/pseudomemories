...
export default function SectionAbout() {
    return (
        <section className="relative w-full min-h-screen flex items-center justify-center px-6 py-32 bg-linear-to-b from-cyan-200 via-cyan-500 to-vermelion-600">
            <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <motion.div
                    ...
                    className="space-y-6"
                >
                    <p className="text-micro uppercase tracking-widest text-vermelion/80">
                        About Simulasi
                    </p>

                    <h2 className="font-electrolize text-4xl lg:text-5xl leading-tight text-black/90">
                        Pseudo Memories
                        <br />
