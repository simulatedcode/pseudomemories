...
export default function ContactPage() {
    ...
    useGSAP(() => {
        ...
        // Form Content Entrance (socials + form)
        ...
        if (parallaxContentRef.current) {
            gsap.to(parallaxContentRef.current, {
                yPercent: -30,
                ease: "none",
                scrollTrigger: {
        ...
        <div ref={containerRef} style={{ height: "140vh" }} className="relative z-content w-full">
            <div className="fixed top-0 h-screen w-full overflow-hidden flex flex-col md:flex-row bg-background">
                ...
                <div className="w-full md:w-[65%] h-[70vh] md:h-full overflow-hidden flex flex-col px-6 md:px-spacing-12 py-12 md:py-24">
                    <div ref={parallaxContentRef} className="will-change-transform w-full">
                        <div
                            ref={formContentRef}
                            className="max-w-xl w-full flex flex-col gap-16 pb-24 opacity-0 translate-x-5"
                        >
                            {/* Social Links */}
