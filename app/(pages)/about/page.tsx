    ...
    return (
        <div ref={containerRef} className="relative w-full min-h-screen">
            <div className="fixed top-0 h-screen w-full overflow-hidden flex flex-col md:flex-row bg-background ">
                {/* Left: Pinned Headers */}
                <div ref={sidebarRef} className="w-full md:w-[32%] h-[60vh] md:h-full flex flex-col justify-center px-6 md:px-spacing-10 py-8 md:py-0 border-b md:border-b-0 md:border-r border-white/10 z-20 bg-background/80 backdrop-blur-sm">
                    ...
                    <div className="w-full aspect-4/3 md:aspect-3/4 bg-zinc-900 border border-white/10 relative overflow-hidden group mt-20 sm:mt-14 md:mt-12">
                        <div className="absolute inset-0 flex items-center justify-center text-white/20 font-doto uppercase tracking-widest text-micro">
                            ...
                            <div
                                ref={portraitRef}
                                className="w-full h-full relative bg-zinc-900 border border-white/10 overflow-hidden group opacity-0 -translate-x-5"
                            >
                ...
                <div className="w-full md:w-[68%] h-[70vh] md:h-full overflow-y-auto no-scrollbar flex flex-col justify-center px-spacing-08 md:px-spacing-12 py-8 md:py-0">
                    ...
                    <div
                        ref={headerRef}
                        className="flex flex-col gap-6 mt-[14svh] md:mt-2 opacity-0 translate-y-8"
                    >
                    ...
                    <div
                        ref={contentRef}
                        className="max-w-2xl space-y-12 opacity-0 translate-x-5"
                    >
